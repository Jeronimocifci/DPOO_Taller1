...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar pais del atleta a traves del nombre");
	}
	...
	private void ejecutarPaisesPorAtleta() {
	    System.out.println("\n" + "Búsqueda de país por atleta" + "\n");
	
	    String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
	    Map<String, Object> datosAtleta = (Map<String, Object>) calculadora.buscarAtleta(nombreAtleta);
	
	    if (datosAtleta == null) {
	        System.out.println("No se encontró un atleta con ese nombre");
	    } else {
	        String pais = (String) datosAtleta.get("pais");
	        System.out.println("El atleta " + nombreAtleta + " representa a " + pais);
	    }
	}
